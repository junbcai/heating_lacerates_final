...
setwd("/Users/junbc/Documents/GitHub/heating_lacerates_final/respirometry")

out_dir <- "processed_outputs_respirometry"
...
## 2.2 Area data
area_data <- read_csv("~/Documents/GitHub/heating_lacerates_final/respirometry/data/area_data_raw.csv") %>%
  mutate(
    area = area / 100,
